	...
	return (
		<div className="relative h-screen flex items-center justify-center overflow-hidden flex-col bg-[#0f142e">
			...
			<div className="container relative z-10 flex flex-col items-center -mt-16 w-[90%] mx-auto">
				...
				<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-8 text-center font-bold tracking-tight text-white leading-tight">
				...
				<h2 className="mt-6 text-base px-2 text-center sm:text-2xl text-gray-300 font-medium flex flex-col sm:flex-row items-center gap-2">
				...
				<p className="mt-4 text-center text-gray-400 max-w-2xl text-sm sm:text-base">
